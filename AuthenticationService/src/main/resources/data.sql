...
insert into user_permissions(user_id,permission_id) values (-2,'RENT');
insert into user_permissions(user_id,permission_id) values (-2,'SEND_MESSAGE');
insert into user_permissions(user_id,permission_id) values (-2,'CREATE_CODEBOOK');
insert into user_permissions(user_id,permission_id) values (-2,'CREATE_PRICELIST');
insert into user_permissions(user_id,permission_id) values (-2,'PAY');
...
insert into user_permissions(user_id,permission_id) values (-3,'RENT_BY_CREATOR');
insert into user_permissions(user_id,permission_id) values (-3,'VIEW_MY_ADS');
insert into user_permissions(user_id,permission_id) values (-3,'SEND_MESSAGE');
insert into user_permissions(user_id,permission_id) values (-3,'RENT');
insert into user_permissions(user_id,permission_id) values (-3,'CREATE_CODEBOOK');
insert into user_permissions(user_id,permission_id) values (-3,'CREATE_PRICELIST');
insert into user_permissions(user_id,permission_id) values (-3,'PAY');
...
insert into user_permissions(user_id,permission_id) values (-4,'RENT_BY_CREATOR');
insert into user_permissions(user_id,permission_id) values (-4,'VIEW_MY_ADS');
insert into user_permissions(user_id,permission_id) values (-4,'SEND_MESSAGE');
insert into user_permissions(user_id,permission_id) values (-4,'CREATE_CODEBOOK');
insert into user_permissions(user_id,permission_id) values (-4,'RENT');
insert into user_permissions(user_id,permission_id) values (-4,'CREATE_PRICELIST');
...
insert into user_permissions(user_id,permission_id) values (-5,'RENT_BY_CREATOR');
insert into user_permissions(user_id,permission_id) values (-5,'VIEW_MY_ADS');
insert into user_permissions(user_id,permission_id) values (-5,'RENT');
insert into user_permissions(user_id,permission_id) values (-5,'SEND_MESSAGE');
insert into user_permissions(user_id,permission_id) values (-5,'CREATE_CODEBOOK');
